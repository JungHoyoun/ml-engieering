...
`pdb`, `ipdb`, `VSCode Debugger` 등 어떤 도구든 좋습니다. **디버깅 도구를 쓸 줄 모르면, 파이썬을 쓸 줄 아는게 아닙니다.**  
...
- **하나의 버그만 고치지 마세요**  
  ...
  물론 모든 걸 한 번에 고치라는 뜻은 아닙니다.

- **무려 작은 코드 스니펫은 없어도 됩니다**  
  파이썬은 런타임 상태에서 직접 실험할 수 있습니다.  
  따로 테스트 코드를 만들기보다, 디버그 콘솔에서 바로 실험해보세요.
